...
pip install selenium>=4.15.0 webdriver-manager>=4.0.1 python-dotenv>=1.0.0
```
...
3. **Run Analysis**:
   - Select option 2 from the menu to run the analysis
   - The bot will extract your followers and following lists
   - Results will be displayed showing accounts that don't follow you back
...
>>>>>>> 6df6c9261e5d002cddd6b8266721e32b53c7c686
